...
API_HASH = "91738ff9090e4296c980d0affd8e13ae"

BOT_TOKEN = os.environ.get(
    "BOT_TOKEN", "8492501061:AAFiwJYIyxSJKJpfwNFmdg_V70O-cTsAUgc"
)

BOT_ID = int(os.environ.get("BOT_ID", "8492501061"))
...
BOT_NAME = os.environ.get("BOT_NAME", "◖sтαя ꭙ ꝛσʙσᴛ◗")

DB_NAME = os.environ.get("DB_NAME", "StarXCodes")
...
DEVS = list(
    map(
        ...
        os.environ.get(
            "DEVS",
            "8568361057 347422710 6907494019",
        ).split(),
    )
)

AKSES_DEPLOY = list(
    map(int, os.environ.get("AKSES_DEPLOY", "8568361057 347422710").split())
)

OWNER_ID = int(os.environ.get("OWNER_ID", "8568361057"))

LOG_SELLER = int(os.environ.get("LOG_SELLER", "-1003699296351"))

LOG_BACKUP = int(os.environ.get("LOG_BACKUP", "-1003366157454"))
...
SAWERIA_NAME = os.environ.get("SAWERIA_NAME", "ferlyk19")
API_KEY = [
...
FAKE_DEVS = list(map(int, os.environ.get("FAKE_DEVS", "8568361057 347422710").split()))

KYNAN = [8568361057, 347422710, 6907494019]
