...
from Navy.helpers import ButtonUtils
...
__MODULES__ = "ᴄᴀʟᴄᴜʟᴀᴛᴏʀ"
__HELP__ = """<blockquote>Command Help **ᴄᴀʟᴄᴜʟᴀᴛᴏʀ**</blockquote>
<blockquote expandable>--**Basic Commands**--

    **Get inline ᴄᴀʟᴄᴜʟᴀᴛᴏʀ**
        `{0}calc`</blockquote>
<b>   {1}</b>
"""